...
Public Class NotificarErrorAyuda
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        Try
            ...
            CORREO.From = New System.Net.Mail.MailAddress("eincio@medica.com.pe", "Notificación error detectado por usuario: " & StrUser, System.Text.Encoding.UTF8)
            ...
            CORREO.To.Add("eincio@medica.com.pe") 'enriqueincioch@outlook.com.pe")
            'Adicionando copia oculta
            'CORREO.Bcc.Add("luis.m.r@outlook.com")
            CORREO.Bcc.Add("jdepaz@medica.com.pe")

            CORREO.IsBodyHtml = True
            CORREO.AlternateViews.Add(htmlView)

            CORREO.Subject = "Notificación error detectado por usuario: " & StrUser
            SMTP.Host = "mail.medica.com.pe"
            SMTP.Port = "26"

            SMTP.EnableSsl = False
            'SMTP.Credentials = New System.Net.NetworkCredential("apolothreads@gmail.com", "Apolo0525")
            SMTP.Credentials = New System.Net.NetworkCredential("soporteTI@web.medica.com.pe", "3DAF6953DDFF487")
            SMTP.Send(CORREO)

        Catch ex As Exception
            envioOK = False
            cargadoError()
            MessageBox.Show("No se ha podido enviar. Vuelva a intentarlo por favor.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning)
        End Try
    End Sub
    ...
    Private Sub BackgroundWorker1_RunWorkerCompleted(sender As Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        If envioOK = True Then
            cargado()
            MessageBox.Show("Enviado con éxito. Muchas gracias por su colaboración", "Médica (Laboratorio Clínico Especializado)", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
            cargadoError()
        End If
    End Sub
