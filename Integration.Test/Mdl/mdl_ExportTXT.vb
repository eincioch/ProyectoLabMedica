...
Module mdl_ExportTXT
    ...
    Public Sub ExportTXT(ByVal DataGridView As DataGridView, Optional ByVal NombreArchivo As String = "Exportar.txt", Optional ByVal CaracterCorteLinea As String = "¤")

        Dim sFile As String = Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory) + "\" + NombreArchivo
                ...
                With DataGridView
                    ...
                    For fila As Integer = 0 To .RowCount - 1
                        ...
                        For col As Integer = 0 To .Columns.Count - 1
                            ...
                            If .Columns.Item(col).DefaultCellStyle.Format = "N2" Then 'Update 2016-01-20 (EINCIO) 
                                linea = linea & Format(.Item(col, fila).Value, "######0.#0") & DELIMITADOR
                            Else
