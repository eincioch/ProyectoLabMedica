...
Public Class rptVentasxTurno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integration.Test.rptVentasxTurno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasxTurno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasxTurno = New rptVentasxTurno()
        rpt.Site = Me.Site
        Return rpt
    End Function
