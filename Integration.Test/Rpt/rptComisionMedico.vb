...
Public Class rptComisionMedico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integration.Test.rptComisionMedico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComisionMedico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComisionMedico = New rptComisionMedico()
        rpt.Site = Me.Site
        Return rpt
    End Function
