...
Public Class rptListadoExamenes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integration.Test.rptListadoExamenes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListadoExamenes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListadoExamenes = New rptListadoExamenes()
        rpt.Site = Me.Site
        Return rpt
    End Function
