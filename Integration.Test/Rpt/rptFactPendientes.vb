...
Public Class rptFactPendientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Integration.Test.rptFactPendientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFactPendientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFactPendientes = New rptFactPendientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
