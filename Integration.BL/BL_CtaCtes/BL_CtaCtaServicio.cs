...
namespace Integration.BL.BL_CtaCtes
{
    public class BL_CtaCtaServicio
    {
        ...
        //-----------------------------------------------------
        public string Get_CtaCteListaServicio_by_cPerJurCodigo_nCtaCteSerCodigo(string cPerJurCodigo, long nCtaCteSerCodigo)
        {
            BE_ReqCtaCteSerImpDefault Request = new BE_ReqCtaCteSerImpDefault();
            DA_CtaCteServicio da = new DA_CtaCteServicio();
            ...
            return da.Get_CtaCteListaServicio_by_cPerJurCodigo_nCtaCteSerCodigo(Request);
        }
        ...
        {
            DA_CtaCteServicio Obj = new DA_CtaCteServicio();
            return Obj.Get_CtaCteServicioComponente(Request);
        }
