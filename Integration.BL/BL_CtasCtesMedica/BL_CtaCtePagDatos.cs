...
namespace Integration.BL.BL_CtasCtesMedica
{
    ...
    {
        public bool Ins_CtaCtePagDatos(int nCtaCtePagcodigo, string cCtaCtePagDatPerJurCodigo, string cCtaCtePagDatBanco, string cCtaCtePagDatNroCuenta, DateTime dCtaCtePagDatFecha, string cCtaCtePagDatNroOperacion, double fCtaCtePagDatImporte, int nConValor)
        {
            bool exito = false;
