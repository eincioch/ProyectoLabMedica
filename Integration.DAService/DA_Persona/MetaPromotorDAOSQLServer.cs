            ...
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(Cadena))
                {
                    ...
                    using (SqlCommand cm = new SqlCommand())
                    {
                        ...
                        cm.Parameters.AddWithValue("@cFlag", periodo.cFlag);
                        cm.Parameters.AddWithValue("@cFlagFec", cFlagFec);
                        cm.Parameters.AddWithValue("@cPrdIni", cPrdIni);
                        cm.Parameters.AddWithValue("@cPrdFin", cPrdFin);
                        cm.Parameters.AddWithValue("@cPerPromCodigo", cPerPromCodigo);
        ...
        public DataTable Get_Derivaciones_Qty_Amount(string cFecIni = "", string cFecFin = "", string cFlag = "", string cFlag2 = "")
        {
            ...
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(Cadena))
                {
                    ...
                    using (SqlCommand cm = new SqlCommand())
                    {
                        cm.CommandText = "[usp_Get_Derivaciones_Qty_Amount]";
                        cm.CommandType = CommandType.StoredProcedure;
                        cm.Parameters.AddWithValue("@cFecIni", cFecIni);
                        cm.Parameters.AddWithValue("@cFecFin", cFecFin);
                        cm.Parameters.AddWithValue("@cFlag", cFlag);
                        cm.Parameters.AddWithValue("@cFlag2", cFlag2);
