...
namespace Integration.DAService
{
    public class DA_Personas
    {
        ...
        public bool Ins_PerMedicoDetalle(BE_ReqPersona Request)
        {
            ...
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(Cadena))
                {
                    ...
                    using (SqlCommand cm = new SqlCommand())
                    {
                        cm.CommandText = "[usp_Medica_Ins_PerMedico_Detalle]";
                        cm.CommandType = CommandType.StoredProcedure;
                        cm.Parameters.AddWithValue("cPerJurCodigo", Request.cPerJurCodigo);
                        cm.Parameters.AddWithValue("cPerApePat", Request.cPerApellPaterno);
                        cm.Parameters.AddWithValue("cPerApeMat", Request.cPerApellMaterno);
                        cm.Parameters.AddWithValue("cPerNombre", Request.cPerNombre);
                        cm.Parameters.AddWithValue("nPerNatSexo", Request.nPerNatSexo);
                        ...
                        else throw new ApplicationException("se ha producido un error procedimiento almacenado: [usp_Medica_Ins_PerMedico_Detalle]; Consulte al administrador del sistema");
                    }
                }
        ...
        public DataTable Get_Trabajador_By_TipoDoc_DocId(BE_ReqPerIdentifica Request)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(Cadena))
                {
                    ...
                    using (SqlCommand cm = new SqlCommand())
                    {
                        cm.CommandText = "[usp_Marcacion_Get_Trabajador_By_TipoDoc_DocId]";
                        cm.CommandType = CommandType.StoredProcedure;
                        cm.Parameters.AddWithValue("nPerIdeTipo", Request.nPerIdeTipo);
                        cm.Parameters.AddWithValue("cPerIdeNumero", Request.cPerIdeNumero);
        ...
        public DataTable Get_ListPer_By_cPerRelTipo(BE_Req_Persona Request)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(Cadena))
                {
                    ...
                    using (SqlCommand cm = new SqlCommand())
                    {
                        cm.CommandText = "[usp_Admision_Get_ListPer_By_cPerRelTipo]";
                        cm.CommandType = CommandType.StoredProcedure;
