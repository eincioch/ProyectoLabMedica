            ...
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(Cadena))
                {
                    ...
                    using (SqlCommand cm = new SqlCommand())
                    {
                        ...
                        cm.CommandType = CommandType.StoredProcedure;
                        cm.Parameters.AddWithValue("cPerCodigo", Request.cPerCodigo);
                        if (Request.cIntJerarquia != "")  cm.Parameters.AddWithValue("cIntJerarquia", Request.cIntJerarquia);
                        cm.Parameters.AddWithValue("nSisGruCodigo", Request.nSisGruCodigo);
                        cm.Parameters.AddWithValue("nSisGruTipo", Request.nSisGruTipo);
                        cm.Parameters.AddWithValue("nObjTipo", Request.nObjTipo);
                        if (Request.nIntTipo != -1) cm.Parameters.AddWithValue("nIntTipo", Request.nIntTipo);
                        if (Request.nObjCodigo != -1) cm.Parameters.AddWithValue("nObjCodigo", Request.nObjCodigo);
